...
\begin{frame}{10.13 官方参考资料 · 协作、Docker 与本地模型}
  \scriptsize
  \begin{itemize}
    ...
    \item \href{https://docs.docker.com/compose/}{Docker Docs · Compose}
    ...
    \item \href{https://unsloth.ai/docs/get-started/install/pip-install}{Unsloth Docs · Install via pip and uv}
    \item \href{https://unsloth.ai/docs/basics/inference-and-deployment/saving-to-gguf}{Unsloth Docs · Saving to GGUF}
    \item \href{https://unsloth.ai/docs/basics/inference-and-deployment/llama-server-and-openai-endpoint}{Unsloth Docs · llama-server Endpoint}
  \end{itemize}
\end{frame}
