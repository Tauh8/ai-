...
\begin{frame}[fragile]{2.5 真实日志：本地 Commit 已创建}{仓库 Tauh8/ai- · Commit 0fd229a}
  \begin{lstlisting}[language=bash]
...
\begin{frame}[fragile]{2.6 真实日志：Push 更新 GitHub}{Commit 是本地动作，Push 是网络动作}
  \begin{columns}[T]
    \begin{column}{0.48\textwidth}
      \begin{block}{Push 前}
        \begin{lstlisting}[language=bash]
  ...
  deployment and operations lessons
    ...
    \begin{column}{0.48\textwidth}
      \begin{block}{Push 后}
        \begin{lstlisting}[language=bash]
$ git push
To ssh://ssh.github.com:443/Tauh8/ai-.git
...
## main...origin/main
    ...
    \end{column}
  \end{columns}
  \DAtagline{在线仓库}{\DAfile{github.com/Tauh8/ai-}}
\end{frame}
...
\begin{frame}[fragile]{2.8 真实历史：用 log 与 show 追踪变化}{仓库中已经存在 4 个真实 Commit}
  \begin{lstlisting}[language=bash]
